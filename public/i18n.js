...
const TRANSLATIONS = {
  uz: { // Lotin
    ...
    celebrate_title: "Tabriklaymiz!",
    celebrate_subtitle_monthly: "Sizda endi 1 oylik Premium faol",
    celebrate_subtitle_yearly: "Sizda endi 1 yillik Premium faol",
    celebrate_close_btn: "Ajoyib!",
    ...
    referral_subtitle: "Har bir taklif — 1 ball. Ballaringizni pastdagi mukofotlarga almashtiring!",
    referral_points_label: "Sizning ballaringiz",
    referral_share_btn: "📤 Ulashish",
    referral_copy_btn: "🔗 Nusxalash",
    referral_share_text: "Ovqaty — ovqat retseptlari va AI yordamchi bilan! Menga qo'shiling 👇",
    ...
    referral_shop_recipe_title: "1ta Premium retsept ochish",
    referral_shop_view_btn: "Ko'rish",
  ...
  uzk: { // Kirill
    ...
    celebrate_title: "Табриклаймиз!",
    celebrate_subtitle_monthly: "Сизда энди 1 ойлик Premium фаол",
    celebrate_subtitle_yearly: "Сизда энди 1 йиллик Premium фаол",
    celebrate_close_btn: "Ажойиб!",
    ...
    referral_subtitle: "Ҳар бир таклиф — 1 балл. Баллларингизни пастдаги мукофотларга алмаштиринг!",
    referral_points_label: "Сизнинг баллларингиз",
    referral_share_btn: "📤 Улашиш",
    referral_copy_btn: "🔗 Нусхалаш",
    referral_share_text: "Ovqaty — овқат рецептлари ва AI ёрдамчи билан! Менга қўшилинг 👇",
    ...
    referral_shop_recipe_title: "1та Premium рецепт очиш",
    referral_shop_view_btn: "Кўриш",
    ...
    onboarding_title: "Ovqaty'га хуш келибсиз!",
