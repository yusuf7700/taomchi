...
const TRANSLATIONS = {
  uz: { // Lotin
    ...
    premium_popup_subtitle: "Yaxshiroq ta'mlar siz uchun.",
    premium_stat_ai_sub: "AI so'rov / kun",
    premium_stat_recipes_title: "Premium",
    premium_stat_recipes_sub: "retseptlar",
    premium_stat_new_title: "Yangi",
    premium_stat_new_sub: "imkoniyatlarga erta kirish",
    ...
    premium_save: "tejash",
    premium_buy_cta: "Premiumni boshlash",
    ...
    language_label: "Til",
    notifications_daily_label: "Kunlik ovqat eslatmasi",
    notifications_weekly_label: "Haftalik reja eslatmasi",
    sort_default: "Odatiy",
    sort_newest: "🆕 Yangi",
    sort_popular: "🔥 Ko'p ko'rilgan",
    ai_limit_reset: "⏰ Yangi bepul so'rov: {h} soat {m} daqiqadan keyin (00:00da yangilanadi)",
    ai_limit_reset_soon: "⏰ Yangi bepul so'rov: {m} daqiqadan keyin (00:00da yangilanadi)",
    tour_next: "Keyingisi",
    tour_start: "Boshlash",
    tour_skip: "O'tkazib yuborish",
    tour1_title: "Ombordagilardan retsept toping",
    tour1_desc: "Uyingizda bor mahsulotlarni belgilang — mos keladigan retseptlarni o'zi topib beradi.",
    tour2_title: "Haftalik menyuni oldindan tuzing",
    tour2_desc: "Har kunga tushlik va kechki ovqatni bir marta rejalashtiring — kunlik \"nima pishiray\" degan bosh og'rig'idan qutuling.",
    tour3_title: "AI oshpazdan maslahat oling",
    tour3_desc: "Retsept tavsiyasidan tortib, mahsulotni nima bilan almashtirish mumkinligigacha — istalgan savolni bering.",
    premium_chip_ai: "AI cheksiz",
    premium_chip_menu: "Menyu",
    premium_chip_recipes: "Retseptlar",
    premium_expiry_label: "Tugash sanasi",
    weekly_copy_prev: "📋 O'tgan haftani nusxalash",
    weekly_copy_confirm: "O'tgan haftadagi taomlar shu haftaga nusxalansinmi?",
    weekly_copy_confirm_overwrite: "Joriy haftadagi mavjud tanlovlar almashtiriladi. Davom etasizmi?",
    similar_recipes_title: "🍲 Shunga o'xshash retseptlar",
    ramadan_banner_title: "Ramazon muborak bo'lsin!",
    ramadan_banner_subtitle: "Ramazon uchun maxsus taomlar",
    diet_banner_title: "Diyeta taomlari",
    diet_banner_subtitle: "Yengil va foydali retseptlar",
    ...
    pantry_results_found: "ta retsept topildi",
    pantry_back_to_selection: "Tanlashga qaytish",
    pantry_all_category: "Barchasi",
    pantry_view_results: "Retseptlarni ko'rish",
    ...
    weekly_today: "Bugun",
    weekly_this_week: "Bu hafta",
    weekly_next_week: "Keyingi hafta",
    weekly_prev_week: "O'tgan hafta",
    meal_lunch: "Tushlik",
    ...
    ai_hero_title: "Bugun oshxonada nima bor?",
    ai_hero_subtitle: "Qo'lingizdagi mahsulotlarni yozing, men sizga mos taomlarni topib beraman.",
    ai_quick_title: "Tez ovqat",
    ai_quick_desc: "30 daqiqalik taomlar",
    ai_idea_title: "Menga g'oya ber",
    ai_idea_desc: "Kayfiyat va vaqtga qarab tanlaymiz",
    ai_lowbudget_title: "Arzon va sodda",
    ai_lowbudget_desc: "Kam mahsulot bilan",
    ai_guest_title: "Mehmon kutaman",
    ai_guest_desc: "Bayram uchun taklif",
    ai_popular_label: "Mashhur so'rovlar",
    ai_chip_egg: "Tuxum bilan",
    ai_chip_potato: "Kartoshka bilan",
    ai_chip_veg: "Go'shtsiz",
    ai_prompt_quick: "30 daqiqada tayyor bo'ladigan tez ovqat retsepti tavsiya qil",
    ai_prompt_idea: "Bugun nima pishirsam ekan, menga g'oya ber",
    ai_prompt_lowbudget: "Uyda kam mahsulot bor, arzon va sodda nima pishira olaman?",
    ai_prompt_guest: "Mehmon kutayapman, bayram dasturxoni uchun taom tavsiya qil",
  ...
  uzk: { // Kirill
    ...
    recent_searches: "Сўнгги қидирувлар",
    popular_categories: "Машҳур категориялар",
    ...
    premium_popup_subtitle: "Яхшироқ таъмлар сиз учун.",
    premium_stat_ai_sub: "AI сўров / кун",
    premium_stat_recipes_title: "Premium",
    premium_stat_recipes_sub: "рецептлар",
    premium_stat_new_title: "Янги",
    premium_stat_new_sub: "имкониятларга эрта кириш",
    ...
    premium_save: "тежаш",
    premium_buy_cta: "Премиумни бошлаш",
    ...
    language_label: "Тил",
    notifications_daily_label: "Кунлик овқат эслатмаси",
    notifications_weekly_label: "Ҳафталик режа эслатмаси",
    sort_default: "Одатий",
    sort_newest: "🆕 Янги",
    sort_popular: "🔥 Кўп кўрилган",
    ai_limit_reset: "⏰ Янги бепул сўров: {h} соат {m} дақиқадан кейин (00:00да янгиланади)",
    ai_limit_reset_soon: "⏰ Янги бепул сўров: {m} дақиқадан кейин (00:00да янгиланади)",
    tour_next: "Кейингиси",
    tour_start: "Бошлаш",
    tour_skip: "Ўтказиб юбориш",
    tour1_title: "Омбордагилардан рецепт топинг",
    tour1_desc: "Уйингизда бор маҳсулотларни белгиланг — мос келадиган рецептларни ўзи топиб беради.",
    tour2_title: "Ҳафталик менюни олдиндан тузинг",
    tour2_desc: "Ҳар кунга тушлик ва кечки овқатни бир марта режалаштиринг — кунлик \"нима пиширай\" деган бош оғриғидан қутулинг.",
    tour3_title: "AI ошпаздан маслаҳат олинг",
    tour3_desc: "Рецепт тавсиясидан тортиб, маҳсулотни нима билан алмаштириш мумкинлигигача — истаган саволни беринг.",
    premium_chip_ai: "AI чексиз",
    premium_chip_menu: "Меню",
    premium_chip_recipes: "Рецептлар",
    premium_expiry_label: "Тугаш санаси",
    weekly_copy_prev: "📋 Ўтган ҳафтани нусхалаш",
    weekly_copy_confirm: "Ўтган ҳафтадаги таомлар шу ҳафтага нусхалансинми?",
    weekly_copy_confirm_overwrite: "Жорий ҳафтадаги мавжуд танловлар алмаштирилади. Давом этасизми?",
    similar_recipes_title: "🍲 Шунга ўхшаш рецептлар",
    ramadan_banner_title: "Рамазон муборак бўлсин!",
    ramadan_banner_subtitle: "Рамазон учун махсус таомлар",
    diet_banner_title: "Диета таомлари",
    diet_banner_subtitle: "Енгил ва фойдали рецептлар",
    support_title: "Ёрдам",
    ...
    pantry_results_found: "та рецепт топилди",
    pantry_back_to_selection: "Танлашга қайтиш",
    pantry_all_category: "Барчаси",
    pantry_view_results: "Рецептларни кўриш",
    ...
    weekly_today: "Бугун",
    weekly_this_week: "Бу ҳафта",
    weekly_next_week: "Кейинги ҳафта",
    weekly_prev_week: "Ўтган ҳафта",
    meal_lunch: "Тушлик",
    ...
    ai_hero_title: "Бугун ошхонада нима бор?",
    ai_hero_subtitle: "Қўлингиздаги маҳсулотларни ёзинг, мен сизга мос таомларни топиб бераман.",
    ai_quick_title: "Тез овқат",
    ai_quick_desc: "30 дақиқалик таомлар",
    ai_idea_title: "Менга ғоя бер",
    ai_idea_desc: "Кайфият ва вақтга қараб танлаймиз",
    ai_lowbudget_title: "Арзон ва содда",
    ai_lowbudget_desc: "Кам маҳсулот билан",
    ai_guest_title: "Меҳмон кутаман",
    ai_guest_desc: "Байрам учун таклиф",
    ai_popular_label: "Машҳур сўровлар",
    ai_chip_egg: "Тухум билан",
    ai_chip_potato: "Картошка билан",
    ai_chip_veg: "Гўштсиз",
    ai_prompt_quick: "30 дақиқада тайёр бўладиган тез овқат рецепти тавсия қил",
    ai_prompt_idea: "Бугун нима пиширсам экан, менга ғоя бер",
    ai_prompt_lowbudget: "Уйда кам маҳсулот бор, арзон ва содда нима пишира оламан?",
    ai_prompt_guest: "Меҳмон кутаяпман, байрам дастурхони учун таом тавсия қил",
